...
class Carrada(Dataset):
    def __init__(self,ra_map_dir,rd_map_dir,ad_map_dir,mask_dir,center_dir,ra_transform = None,rd_transform=None,ad_transform=None):
    ...
    def __getitem__(self,index):
        ...
        return ra_map, rd_map, ad_map, mask ,center, self.ra_map_list[index]   
