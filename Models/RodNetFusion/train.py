...
from model_mid_fusion import RODnet
import math
import numpy as np
import sys
...
# Hyperparameters 
LEARNING_RATE = 1e-4
W1,W2 = 1,1 #(focal loss, center loss)
...
def main():
    mMSE = 1e10
    mfocal = 1e10
    writer = SummaryWriter(f"runs/mid_fusion_transformer_chn_attent_noise_0.1_last_{LEARNING_RATE}_{W1}_{W2}")
    step = 0
